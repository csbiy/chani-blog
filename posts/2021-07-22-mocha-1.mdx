---
id: 74
title: "browser javascript test하기(Mocha,NodeJs)"
description: ""
...
기본 템플릿은 다음과 같다. 유의할 점은 command line interface를 지원해주지 않고, html 을 통해서 테스트 결과를 확인할 수 있다. 
...
test할 client javascript file을 import한다. 이때, javascript module 시스템을 브라우저에서 하려면
