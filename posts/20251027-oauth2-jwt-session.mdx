...
![Session Based Authentication](/images/session-auth.jpg)
...
![Token Based Authentication](/images/token-auth.jpg)
...
![OAuth 2.0 Authorization Code Flow](/images/oauth2-auth-code-flow.png)
