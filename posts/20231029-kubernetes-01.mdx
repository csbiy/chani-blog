...
<figure>
  <img src="/images/KUBER_POD_01.png"></img>
...
<figure>
  <img src="https://k21academy.com/wp-content/uploads/2020/11/2918027a-kublr1.png"></img>
...
pod안에 생성되는것이기 때문에 pod에 문제가 생겨 재생성된다면 날라간다. 즉 휘발적인 데이터만 넣어야한다. 
...
다만 Value의 경우는 base64 인코딩해서 넣음. pod로 넣을 때는 자동으로 decoding. 
...
pod나 service를 만들 때 속할 namespace를 지정할 수 있음
