...
description: "Java LTS(Long-Term Support) 버전인 8, 11, 17, 21, 25의 주요 기능, GC 알고리즘 변화, 마이그레이션 가이드를 상세히 정리"
...
- Records, Sealed Classes, Pattern Matching 사용 가능
- Text Blocks 사용 가능
...
**주요 변경사항:**
- Virtual Thread 도입
- Generational ZGC 정식 지원
- Record Patterns, Sequenced Collections 사용 가능

```java
// Virtual Thread 적용 시 synchronized 점검 필요
// 기존 synchronized를 ReentrantLock으로 변경 고려
```
