...
*Factory란 호출할 때마다 특정 타입의 인스턴스를 반복해서 만들어주는 객체를 말하며, 디자인패턴을 말한다. 자세한 내용 참조 ([Design Pattern/Factory method Pattern](https://devcs96.github.io/2021/07/20/2021-07-20-item4/#more],참조))
